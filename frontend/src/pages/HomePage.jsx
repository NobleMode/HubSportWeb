...
const HomePage = () => {
  ...
  return (
    <div className="min-h-screen bg-white pb-20">
      {/* Hero Search Section */}
      <div className="bg-gradient-to-b from-[#0f172a] via-[#1e293b] to-white pt-20 pb-32 px-6 relative overflow-hidden">
        {/* Abstract shapes */}
        <div className="absolute top-0 right-0 w-96 h-96 bg-blue-500 opacity-20 rounded-full blur-3xl -mr-20 -mt-20"></div>
        <div className="absolute top-20 left-0 w-80 h-80 bg-cyan-400 opacity-20 rounded-full blur-3xl -ml-20"></div>
        ...
        <div className="container mx-auto max-w-4xl text-center relative z-10">
          ...
          >
            <input
              ...
              className="w-full py-4 px-8 pr-16 rounded-full text-gray-900 focus:outline-none focus:ring-4 focus:ring-blue-500/30 shadow-2xl text-lg placeholder-gray-400"
              value={searchTerm}
              onChange={(e) => setSearchTerm(e.target.value)}
            />
            <button
              type="submit"
              className="absolute right-2 top-2 p-2.5 bg-blue-600 text-white rounded-full hover:bg-blue-700 transition duration-200"
            >
              <svg
          ...
          <div className="flex flex-wrap justify-center gap-4">
            {categories.map((cat) => (
              <Link
                ...
                className="bg-white text-gray-800 px-6 py-2.5 rounded-full font-bold hover:scale-105 hover:shadow-lg transition-all duration-200 shadow flex items-center gap-2"
              >
        ...
        <div className="flex justify-between items-end mb-8 border-b border-gray-100 pb-4">
          <div>
            <h2 className="text-3xl font-extrabold text-[#0f172a]">
              Most popular rentals this week
            </h2>
            <p className="text-gray-500 mt-2 font-medium">
              Trending equipment everyone is renting
            </p>
          </div>
          <Link
            to="/products"
            className="text-gray-600 font-semibold hover:text-blue-600 flex items-center gap-1 transition-colors"
          >
            View All
            <svg
              xmlns="http://www.w3.org/2000/svg"
              ...
              >
                <div className="relative h-56 bg-gray-100 overflow-hidden">
                  ...
                  {product.isRecommended && (
                    <div className="absolute top-3 left-3">
                       <span className="bg-yellow-400 text-yellow-900 text-[10px] font-bold px-2 py-1 rounded shadow-sm flex items-center gap-1 w-max">
                ...
                <div className="p-5 flex flex-col flex-grow">
                  ...
                  <div className="mt-auto flex items-center justify-between">
                    ...
                    <div className="w-10 h-10 rounded-full bg-gray-50 flex items-center justify-center text-gray-400 group-hover:bg-green-500 group-hover:text-white transition-colors">
                      <svg
                        xmlns="http://www.w3.org/2000/svg"
                        className="h-5 w-5"
                        fill="none"
        ...
        <div className="bg-white rounded-3xl p-8 md:p-12 shadow-xl border border-gray-100 relative overflow-hidden flex flex-col md:flex-row items-center gap-12">
          ...
          <div className="relative z-10 md:w-1/2 text-left">
            <h2 className="text-3xl md:text-5xl font-extrabold mb-6 text-gray-800 leading-tight">
              Seasonal Sale: <br />
              <span className="text-[#DC143C] bg-clip-text bg-gradient-to-r from-electricBlue to-blue-600">
                Up to 50% Off
              </span>
            </h2>
            ...
            <Link
              ...
              className="inline-block text-center text-black border  bg-electricBlue font-bold px-10 py-4 rounded-full hover:bg-electricBlue-hover hover:shadow-lg hover:-translate-y-1 transition-all duration-300"
            >
              Shop Sale Items
            </Link>
          </div>
